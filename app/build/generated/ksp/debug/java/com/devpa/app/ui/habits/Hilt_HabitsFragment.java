...
public abstract class Hilt_HabitsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HabitsFragment_GeneratedInjector) this.generatedComponent()).injectHabitsFragment(UnsafeCasts.<HabitsFragment>unsafeCast(this));
    }
  }
