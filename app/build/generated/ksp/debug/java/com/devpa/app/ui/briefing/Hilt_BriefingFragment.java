...
public abstract class Hilt_BriefingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BriefingFragment() {
    super();
  }

  Hilt_BriefingFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BriefingFragment_GeneratedInjector) this.generatedComponent()).injectBriefingFragment(UnsafeCasts.<BriefingFragment>unsafeCast(this));
    }
  }
