...
public abstract class Hilt_PortfolioFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PortfolioFragment() {
    super();
  }

  Hilt_PortfolioFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PortfolioFragment_GeneratedInjector) this.generatedComponent()).injectPortfolioFragment(UnsafeCasts.<PortfolioFragment>unsafeCast(this));
    }
  }
