...
public abstract class Hilt_JobsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobsFragment_GeneratedInjector) this.generatedComponent()).injectJobsFragment(UnsafeCasts.<JobsFragment>unsafeCast(this));
    }
  }
