...
public abstract class Hilt_EmailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmailFragment_GeneratedInjector) this.generatedComponent()).injectEmailFragment(UnsafeCasts.<EmailFragment>unsafeCast(this));
    }
  }
